...
public class BigCactusCornerBlock extends HorizontalFacingBlock
{
	...
	protected static final VoxelShape HITBOX_DIMENSIONS = Block.createCuboidShape(1.0D, 1.0D, 1.0D, 15.0D, 15.0D, 16.0D);
	...
	public boolean canCactusSurviveHere(BlockView world, BlockPos pos, Direction facing) {
