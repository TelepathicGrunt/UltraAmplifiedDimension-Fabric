...
public class RegionManager {
     ...
     */
    public BiomeGroup getRandomBiomeGroup(Pair<List<BiomeGroup>, Integer> regionGroup, LayerRandomnessSource context){
        // Now choose a random item.
        int index = 0;
        for (double randomWeightPicked = context.nextInt(regionGroup.getSecond()); index < regionGroup.getFirst().size() - 1; ++index) {
