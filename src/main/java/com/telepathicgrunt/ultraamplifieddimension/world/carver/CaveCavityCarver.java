...
public class CaveCavityCarver extends Carver<CaveConfig>
{
	...
	@Override
	public boolean carveRegion(Chunk region, Function<BlockPos, Biome> biomeBlockPos, Random random, int seaLevel, int chunkX, int chunkZ, int originalX, int originalZ, BitSet mask, CaveConfig config) {
