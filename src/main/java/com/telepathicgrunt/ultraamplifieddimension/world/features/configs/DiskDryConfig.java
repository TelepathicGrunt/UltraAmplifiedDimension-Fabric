...
public class DiskDryConfig implements FeatureConfig {
    ...
    public static final Codec<DiskDryConfig> CODEC = RecordCodecBuilder.create((diskDryConfig) -> diskDryConfig.group(
            ...
            UniformIntDistribution.createValidatedCodec(1, 36, 36).fieldOf("radius").forGetter((config) -> config.radius),
    ...
    public DiskDryConfig(BlockState blockState, UniformIntDistribution radius, int half_height, List<BlockState> targets, boolean exposedOnly) {
