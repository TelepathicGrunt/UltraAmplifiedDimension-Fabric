...
public class BadlandsSurfaceBuilder extends SurfaceBuilder<TernarySurfaceConfig> {
    ...
    public void buildSurface(Random random, Chunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise, BlockState defaultBlock, BlockState defaultFluid, int seaLevel, long seed, TernarySurfaceConfig config) {
        ...
        BlockState blockstate1 = config.getUnderMaterial();
                ...
                if (blockstate2.getMaterial() == Material.AIR) {
                    ...
                    if (depth == -1) {
                        ...
                        if (k <= 0) {
                            ...
                            blockstate1 = config.getUnderMaterial();
                        }
    ...
    public void initSeed(long seed) {
        ...
        if (this.field_215433_b != seed || this.field_215435_c == null || this.field_215437_d == null) {
            ...
            this.field_215435_c = new OctaveSimplexNoiseSampler(random, IntStream.rangeClosed(-3, 0));
            this.field_215437_d = new OctaveSimplexNoiseSampler(random, ImmutableList.of(0));
        }
    ...
    protected void func_215430_b(long p_215430_1_) {
        ...
        ChunkRandom random = new ChunkRandom(p_215430_1_);
        this.field_215439_e = new OctaveSimplexNoiseSampler(random, ImmutableList.of(0));
    ...
    protected BlockState func_215431_a(int p_215431_1_, int p_215431_2_, int p_215431_3_) {
        int i = (int) Math.round(this.field_215439_e.sample(p_215431_1_ / 512.0D, p_215431_3_ / 512.0D, false) * 2.0D);
